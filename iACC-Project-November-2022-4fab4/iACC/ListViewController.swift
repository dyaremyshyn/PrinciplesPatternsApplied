...
extension UIViewController {
    func select(friend: Friend) {
        ...
        vc.friend = friend
        show(vc, sender: self) // instead of navController.pushController() use show()
    }
    ...
    func show(error: Error) {
        ...
        self.showDetailViewController(alert, sender: self) // instead of self.presenterVC.present() us showDetailViewController()
    }
}
